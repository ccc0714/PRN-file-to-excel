...
with st.expander("⚙️ Options"):
    ...
    format_label = st.radio(
        ...
        help=(
            "Proportion Correct: shows raw food/no-food counts and one overall proportion.\n"
            "Three Proportions: shows trial-type counts and a separate proportion for L, C, R."
        ),
    )
    summary_format = SUMMARY_FORMATS[format_label]
            ...
            with tempfile.TemporaryDirectory() as tmp:
                ...
                for i, uf in enumerate(uploaded_files):
                    ...
                    try:
                        ...
                        prn_to_excel(prn_path, xlsx_path, sheet_name, summary_format=summary_format)
